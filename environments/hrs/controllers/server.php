...
class server extends identityController
{
        ...
        public function modify()
	{
		...
		switch ($this->input['action'])
		{
			...
			case 'adminSetPassword':
                                parent::modify();
                                break;
                        case 'setServerPermission':
                        case 'adminSetServerPermission':
                                
                                require_once $_SERVER['_HTDOCS_'] . '/environments/hrs/models/serverPermission.php';
                                ...
                                {
                                        if (in_array($input, hrsServerPermissionModel::$permissions))
                                        {
                                ...
                                {
                                        error::addError('Server already has this permission');
                                        throw new error(errorCodes::ERROR_EXPECTATION_FAILED);
                                }
