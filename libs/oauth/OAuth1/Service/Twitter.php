...
class Twitter extends AbstractService
{
	...
	CredentialsInterface $credentials, ClientInterface $httpClient, TokenStorageInterface $storage, SignatureInterface $signature, UriInterface $baseApiUri = null
	)
	{
	...
	protected function parseAccessTokenResponse($responseBody)
	{
		...
		if (null === $data || !is_array($data) || isset($data['<?xml_version']))
		{
			throw new TokenResponseException('Unable to parse response.');
		}
